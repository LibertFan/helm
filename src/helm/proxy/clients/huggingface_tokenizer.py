        ...
        def load_tokenizer(hf_tokenizer_name: str, revision: Optional[str] = None):
            ...
            try:
                ...
                return AutoTokenizer.from_pretrained(
                    hf_tokenizer_name, local_files_only=True, use_fast=True, trust_remote_code=True, **tokenizer_kwargs
                )
            except OSError:
                hlog(f"Local files do not exist for HuggingFace tokenizer: {hf_tokenizer_name}. Downloading...")
                return AutoTokenizer.from_pretrained(
                    hf_tokenizer_name, local_files_only=False, use_fast=True, trust_remote_code=True, **tokenizer_kwargs
                )
